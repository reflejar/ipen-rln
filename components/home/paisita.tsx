export default function Paisita() {
  return (
    <section className="bg-[url('/img/bg-fondo.png')] bg-cover bg-center ">
      ...
      <div className="bg-[url('/img/bg-paisitas.png')] bg-cover bg-center h-screen relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
        {/* Content */}
        <div className="relative z-10 max-w-7xl mx-auto px-8 sm:px-16 bg-[url('/img/papel1.png')] h-full bg-contain bg-no-repeat bg-center ">
