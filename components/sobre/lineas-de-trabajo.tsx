...
export default function LineasTrabajo() {
  return (
    <section className="bg-[url('/img/bg-lineas-mobile.png')] md:bg-[url('/img/bg-lineas.webp')] bg-cover bg-center h-screen relative min-h-screen grid grid-cols-1 md:grid-cols-12 text-center overflow-hidden pt-16">
