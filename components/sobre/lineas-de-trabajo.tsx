        ...
        <div className="w-10/12 mx-auto grid lg:grid-cols-4 gap-12 items-center mb-20">
          ...
          {lineas.map((linea, idx) => (
            <div key={idx} className="text-center">
              <p
                className={`bg-[url('/img/frame.png')] w-2/3 md:w-full md:px-10 py-16 text-5xl md:text-6xl text-center mb-8 max-w-2xl mx-auto lg:mx-0 font-extrabold ${linea.color}`}
