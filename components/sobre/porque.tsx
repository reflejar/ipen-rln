export default function PorQue() {
  return (
    <section className="bg-[url('/ipen-rln/img/bg-papel.png')] bg-cover bg-center bg-no-repeat  -my-20 z-20 h-screen relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
