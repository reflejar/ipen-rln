export default function Objetivos() {
  return (
    <section
      ...
      className="bg-[url('/img/bg-objetivo-gral-mobile.webp')] md:bg-[url('/img/bg-objetivo-gral.webp')] bg-[auto_100%] md:bg-cover md:bg-center relative min-h-screen flex items-center justify-center overflow-hidden pt-16"
    >
